...
public class Main {
    ...
    public static void main(String [] args) throws InterruptedException {
        ...
        WaitZone arrivalZone = new WaitZone("arrival", Params.ARRIVEAL_ZONE_SIZE);
        WaitZone departureZone = new WaitZone("departure", Params.DEPARTURE_ZONE_SIZE);
        TugController tugs = new TugController(Params.NUM_TUGS);
